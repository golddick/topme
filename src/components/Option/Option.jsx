   ...
   <div className="optionWrapper">
     <div className="option">
      ...
      {/* <NavLink to='/signup' className='navlink'>  */}
         ...
         <svg xmlns="http://www.w3.org/2000/svg" width="150" height="250" viewBox="0 0 210 179" fill="url(#myGradient)" className='svgLeft'>
         ...
         <svg xmlns="http://www.w3.org/2000/svg" width="150" height="250" viewBox="0 0 210 179" fill="url(#myGradient)" className='svgRight'>
