   ...
   <div className="optionWrapper">
    ...
    <div className="option">
       ...
       {/* <NavLink to='/signup' className='navlink'>  */}
          ...
          <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 210 179" fill="url(#myGradient)" className='svgLeft'>
          <linearGradient id="myGradient" gradientTransform="rotate(90)">
               <stop offset="0%" stopColor="#43C4B2" />
               <stop offset="10%" stopColor="#43C4B2" />
               <stop offset="15%" stopColor="#43C4B2" />
               <stop offset="20%" stopColor="#43C4B2" />
               <stop offset="25%" stopColor="#43C4B2" />
               <stop offset="27%" stopColor="#c0deda" />
               <stop offset="29%" stopColor="#c0deda" />
               <stop offset="30%" stopColor="#c0deda" />
          ...
          <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 210 179" fill="url(#myGradient)" className='svgRight'>
         ...
         <p> <MdOutlineKeyboardArrowRight className='textIcon'/>Click the “Become an Angel” button</p>
