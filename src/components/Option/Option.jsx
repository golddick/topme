   ...
   <div className="optionWrapper">
     <div className="option">
      ...
      <NavLink to='/signup' className='navlink'> 
        ...
        <p> <BsDot className='textIcon'/>Click the “Become anAngel” button</p>
        <p> <BsDot  className='textIcon'/>Fill in your personal information and create an account.</p>
        <p> <BsDot className='textIcon'/>Wait for approval</p>
        <p> <BsDot  className='textIcon'/>Gain access to your dashboard</p>
        </div>
       ...
       <div className="selectTab">
         ...
         <div className="downtext">
         <p> <BsDot className='textIcon'/>Identify a cause that requires funding and support</p>
        <p> <BsDot  className='textIcon'/>Find a reputable institution that can carry out the aid effectively</p>
        <p> <BsDot className='textIcon'/>Determine the total cost of the cause</p>
        <p> <BsDot  className='textIcon'/>Proceed to create a cause by providing all the necessary details</p>
        </div>
       </div>
       ...
       <div className="selectTab">
         ...
         <p> <BsDot className='textIcon'/>Click the “Become anAngel” button</p>
        <p> <BsDot  className='textIcon'/>Fill in your personal information and create an account.</p>
        <p> <BsDot className='textIcon'/>Wait for approval; Gain access to your dashboard</p>
