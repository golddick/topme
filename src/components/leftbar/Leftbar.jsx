  ...
  return (
    <div className='Leftbar' >
       ...
       <div    className={`nav ${isCurrentPage('/profile') ? 'active' : ''}`}
        ...
        {isHovered && <FiGift className="icon" />}CREATE CAMPAIGN 
        </button>
        {/* </div> */}
        </NavLink>
        </div>
