      ...
      <img src={Logo} alt="" className='logoImage'/>
       <div className="top">
        ...
        <div className="profileInfo">
            <img src='https://i.dailymail.co.uk/1s/2020/11/05/20/35306112-8918801-image-a-4_1604607816563.jpg'
            alt="" className="profileImg"/>
            {/* <img src={profilePhoto}
            alt="" className="profileImg"/> */}
            <div className='editProfile' >
              <NavLink to='/updateprofile' className='navLink' >
              <BiChevronDown className='editIcon'/>
              </NavLink>
              </div>
               </div> 
               <div className="name">
               <span className='userName'>Frank Doe &nbsp;&nbsp;
               ...
               {/* <span className='userName'>{firstname} {lastname} &nbsp;&nbsp;
                ...
                {/* <p>{description}</p> */}
                <div className='info'>
               <span className='address'>  <HiOutlineLocationMarker className='Icon'/>Abuja, Nigeria</span>
               {/* <span className='address'>  <HiOutlineLocationMarker className='Icon'/> {location}, Nigeria</span> */}
                <span className='date'> <MdDateRange className='Icon'/>JOINED june 2023</span>
                ...
                {btnisHovered && <FiGift className="icon" />}
                <FiGift className="mobile-icon" />
                CREATE ANGEL SUPPORT
                </div>
                </NavLink>
       ...
       <div    className={`nav ${isCurrentPage('/profile') ? 'active' : ''}`}
          onClick={() => handleLinkClick('/profile')}>
            ...
            <span >Profile</span>
            {isCurrentPage('/profile') && <div className="activeLine"></div>}
          </div>
          </NavLink>
        ...
        <span> Analytics</span>
        {isCurrentPage('/analytics') && <div className="activeLine"></div>}
        </div>
        </NavLink>

        <div className="nav" >
        <FaRegEnvelope className='NavIcon'/>
        <span>Message</span>
              <div className="messageNot">6</div>
              {isCurrentPage('/') && <div className="activeLine"></div>}
        </div>
        <div className="nav"> 
        <SendOutlinedIcon className='NavIcon'/>
        <span>Email</span>
        {isCurrentPage('/') && <div className="activeLine"></div>}
        </div>
          <NavLink to='/CreatePost' className='navLink' >
        <div onMouseEnter={handleHover} onMouseLeave={handleHover} className='CACbtn' >
        {isHovered && <FiGift className="icon" />}
        <FiGift className="mobile-icon" />
        Create a CAUSE
        </div>
        </NavLink>
