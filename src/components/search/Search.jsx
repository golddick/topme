    ...
    <div className='search' >
        <div className="searchContainer">
            ...
            <div className="containerRight">
                <button>angel login</button>
                <button style={{backgroundColor:'#68EDCB', color: 'white'}}>angel sign up</button>
            </div>
            </div>
              ...
              <div className="slide" key={index}>
                <div className="impactBox">
                  ...
                  <div className="impactBody">
                    <div className="name">
                      <span className='Uname'>{item.impactName}</span>
                  ...
                  <NavLink to="/donor" className="navlink">
                    <div className="btn">
                        <button> view impact story <BiChevronRight /></button>
                    </div>
                  </NavLink>
                </div>
              </div>
